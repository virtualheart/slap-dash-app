...
public class Register extends Activity {
	...
	Button btn_reg_register,btn_back;
...
//					});
	...
	public void call()
	{
		try
		{
			...
			final String username = txtbox_reg_user.getText().toString().trim();
			final String password = txtbox_reg_pass.getText().toString().trim();
			final String cpassword = txtbox_reg_repass.getText().toString().trim();
			final String email = txtbox_reg_mail.getText().toString().trim();
			final String phone = txtbox_reg_phone.getText().toString().trim();
...
//							startActivity(new Intent(getApplicationContext(), Home.class));
							Intent objint = new Intent(Register.this,Home.class);
//							objint.putExtra("name",userJson.getString("username"));
