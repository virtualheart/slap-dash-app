...
//		phone    = intobj.getStringExtra("phone");
	...
	bt_back=(Button)findViewById(R.id.buttoneventtype);
...
//		});
	   ...
	   bt_back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intObj1 = new Intent(GetList.this,AdminHome.class);
	...
	listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent iobj = new Intent(GetList.this, GetView.class);
	...
	public void callBusList()
	{
		try
		{
			...
			String SOAP_ACTION = "http://tempuri.org/geImagelist";
			String METHOD_NAME = "geImagelist";
